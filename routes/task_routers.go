...
func TaskRoutes(app *fiber.App) {
	...
	route.Put("/:id", middleware.Auth(), middleware.ValidateJwt(), controllers.UpdateTask)
	route.Delete("/:id", middleware.Auth(), middleware.ValidateJwt(), controllers.DeleteTask)
}